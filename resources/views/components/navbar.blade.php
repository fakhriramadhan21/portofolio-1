	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar ftco-navbar-light site-navbar-target" id="ftco-navbar">
		<div class="container">
			<a class="navbar-brand" href="/">Fakhri Ramadhan</a>
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav nav ml-auto">
					...
					<li class="nav-item"><a href="{{url('#resume-section')}}" class="nav-link"><span>Resume</span></a></li>
					<li class="nav-item"><a href="{{url('#skills-section')}}" class="nav-link"><span>Skills</span></a></li>
					<li class="nav-item"><a href="{{url('#projects-section')}}" class="nav-link"><span>Proyek</span></a></li>
					<li class="nav-item"><a href="{{url('#jasa')}}" class="nav-link"><span>Services</span></a></li>
